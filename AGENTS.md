...
This is the canonical cross-tool instruction file, following the [AGENTS.md](https://agents.md) open standard adopted by Codex, Cursor, Windsurf, Gemini CLI, RooCode, Zed, and others. Any tool that supports this file should load it first.
